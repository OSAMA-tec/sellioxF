  ...
  return (
    <nav className="flex justify-between items-center px-3 py-3 md:py-4 lg:py-5 md:px-6 lg:px-10 mx-auto relative shadow-sm">
      ...
      <div className="flex items-center gap-2 md:hidden">
        {!user && (
          <Link to="/auth/login" className="p-2 text-primaryA0 hover:bg-primaryA0/10 rounded-full transition-colors" aria-label="Login">
        ...
        <Link to="/addList" className="p-2 text-primaryA0 hover:bg-primaryA0/10 rounded-full transition-colors" aria-label="Create Listing">
      ...
      <div className="hidden md:flex items-center gap-6">
        <div className="flex gap-6 items-center">
          {!user && (
            <>
              <Link to="/auth/login" className="hover:text-primaryA0 transition-colors font-medium">
                Login
              </Link>
              <Link to="/auth/register" className="hover:text-primaryA0 transition-colors font-medium">
                Register
              </Link>
            </>
          )}
            ...
            <div className="flex justify-center mb-4">
              {user?.avatar ? (
                ...
                <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center">
                  <span className="text-gray-700 font-medium text-xl">{user?.name?.charAt(0)?.toUpperCase() || "U"}</span>
                </div>
              )}
            </div>
